...
- Use the AT commands to set HC05 to master (AT+ROLE=1) and use AT+BIND=ADDRESS to bind the transmission to the address of the HC06.
- Restart the power, reset baud rates, and upload the configuration code. When powered, both modules should connect.
